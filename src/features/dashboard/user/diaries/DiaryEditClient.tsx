...
import {
  updateDiary,
  type DiaryPayload,
} from '@/features/dashboard/user/diaries/api/diariesClient';
import { DiaryField } from '@/features/dashboard/user/diaries/components/DiaryField';
import styles from './DiaryEditor.module.css';

type Props = {
  diaryId: string;
  initialDiary: any | null;
};

export function DiaryEditClient({ diaryId, initialDiary }: Props) {
  const router = useRouter();

  const [serverDiary] = useState<any>(initialDiary);
